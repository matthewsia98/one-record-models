...
class CodeListElement(BaseModel):
    ...
    code: List[str] = Field(default_factory=list, serialization_alias="https://onerecord.iata.org/ns/cargo#code")
    ...
    codeDescription: List[str] = Field(default_factory=list, serialization_alias="https://onerecord.iata.org/ns/cargo#codeDescription")
    # label: codeLevel
    ...
    codeLevel: List[int] = Field(default_factory=list, serialization_alias="https://onerecord.iata.org/ns/cargo#codeLevel")
    # label: codeListName
    ...
    codeListName: List[str] = Field(default_factory=list, serialization_alias="https://onerecord.iata.org/ns/cargo#codeListName")
    ...
    codeListReference: List[str] = Field(default_factory=list, serialization_alias="https://onerecord.iata.org/ns/cargo#codeListReference")
    ...
    codeListVersion: List[str] = Field(default_factory=list, serialization_alias="https://onerecord.iata.org/ns/cargo#codeListVersion")