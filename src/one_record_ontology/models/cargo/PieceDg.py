...
from one_record_ontology.models.cargo.DgDeclaration import DgDeclaration
...
class PieceDg(Piece):
    ...
    dgDeclaration: Optional[DgDeclaration] = Field(
        default=None,
    ...
    overpackTypeCode: Optional[CodeListElement] = Field(
        default=None,
    ...
    allPackedInOneIndicator: Optional[bool] = Field(
        default=None,
    ...
    overpackCriticalitySafetyIndexNumeric: Optional[str] = Field(
        default=None,
    ...
    overpackIndicator: Optional[bool] = Field(
        default=None,
    ...
    overpackT1: Optional[bool] = Field(
        default=None,
    ...
    qValueNumeric: Optional[float] = Field(
        default=None,
