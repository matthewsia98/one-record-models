...
from one_record_ontology.models.code_lists.ServiceCode import ServiceCode
...
class Waybill(LogisticsObject):
    ...
    billingDetails: Optional[BillingDetails] = Field(
        default=None,
    ...
    carrierChargeCode: Optional[ChargeCode] = Field(
        default=None,
    ...
    carrierDeclarationPlace: Optional[Location] = Field(
        default=None,
    ...
    customsOriginCode: Optional[CodeListElement] = Field(
        default=None,
    ...
    declaredValueForCarriage: Optional[CurrencyValue] = Field(
        default=None,
    ...
    declaredValueForCustoms: Optional[CurrencyValue] = Field(
        default=None,
    ...
    masterWaybill: Optional[Waybill] = Field(
        default=None,
    ...
    otherChargesIndicator: Optional[PrepaidCollectIndicator] = Field(
        default=None,
    ...
    referredBookingOption: Optional[Booking] = Field(
        default=None,
    ...
    serviceCode: Optional[ServiceCode] = Field(
        default=None,
    ...
    shipment: Optional[Shipment] = Field(
        default=None, serialization_alias="https://onerecord.iata.org/ns/cargo#shipment"
    )
    # label: taxAmount
    # comment: Information about taxes
    # iri: https://onerecord.iata.org/ns/cargo#taxAmount
    taxAmount: Optional[CurrencyValue] = Field(
        default=None,
    ...
    waybillType: Optional[WaybillType] = Field(
        default=None,
    ...
    weightValuationIndicator: Optional[PrepaidCollectIndicator] = Field(
        default=None,
    ...
    accountingInformation: Optional[str] = Field(
        default=None,
    ...
    carrierDeclarationDate: Optional[datetime] = Field(
        default=None,
    ...
    carrierDeclarationSignature: Optional[str] = Field(
        default=None,
    ...
    consignorDeclarationSignature: Optional[str] = Field(
        default=None,
    ...
    destinationCurrencyRate: Optional[float] = Field(
        default=None,
    ...
    modularCheckNumber: Optional[bool] = Field(
        default=None,
