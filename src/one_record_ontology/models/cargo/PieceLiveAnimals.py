...
from one_record_ontology.models.code_lists.GoodsTypeCode import GoodsTypeCode
from one_record_ontology.models.code_lists.GoodsTypeExtensionCode import (
...
class PieceLiveAnimals(Piece):
    ...
    associatedEpermit: Optional[EpermitConsignment] = Field(
        default=None,
    ...
    exportTradeCountry: Optional[CodeListElement] = Field(
        default=None,
    ...
    goodsTypeCode: Optional[GoodsTypeCode] = Field(
        default=None,
    ...
    goodsTypeExtensionCode: Optional[GoodsTypeExtensionCode] = Field(
        default=None,
    ...
    originReferencePermitTypeCode: Optional[CodeListElement] = Field(
        default=None,
    ...
    originTradeCountry: Optional[CodeListElement] = Field(
        default=None,
    ...
    specimenTypeCode: Optional[CodeListElement] = Field(
        default=None,
    ...
    acquisitionDateTime: Optional[datetime] = Field(
        default=None,
    ...
    annualQuotaQuantity: Optional[int] = Field(
        default=None,
    ...
    originReferencePermitDateTime: Optional[datetime] = Field(
        default=None,
    ...
    originReferencePermitId: Optional[str] = Field(
        default=None,
    ...
    quantityAnimals: Optional[int] = Field(
        default=None,
    ...
    specimenDescription: Optional[str] = Field(
        default=None,
