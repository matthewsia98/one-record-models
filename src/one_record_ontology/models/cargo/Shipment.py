...
from one_record_ontology.models.cargo.Insurance import Insurance
...
class Shipment(LogisticsObject):
    ...
    incoterms: Optional[CodeListElement] = Field(
        default=None,
    ...
    waybill: Optional[Waybill] = Field(
        default=None, serialization_alias="https://onerecord.iata.org/ns/cargo#waybill"
    )
