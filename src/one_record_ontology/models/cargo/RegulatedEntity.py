...
from one_record_ontology.models.code_lists.RegulatedEntityCategoryCode import (
...
class RegulatedEntity(BaseModel):
    ...
    owningOrganization: Optional[Organization] = Field(
        default=None,
    ...
    regulatedEntityCategory: Optional[RegulatedEntityCategoryCode] = Field(
        default=None,
    ...
    regulatedEntityExpiryDate: Optional[datetime] = Field(
        default=None,
    ...
    regulatedEntityIdentifier: Optional[str] = Field(
        default=None,
