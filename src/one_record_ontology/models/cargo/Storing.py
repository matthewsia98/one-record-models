...
class Storing(LogisticsAction):
    ...
    storingType: List[StoringType] = Field(default_factory=list, serialization_alias="https://onerecord.iata.org/ns/cargo#storingType")
    ...
    storagePlaceIdentifier: List[str] = Field(default_factory=list, serialization_alias="https://onerecord.iata.org/ns/cargo#storagePlaceIdentifier")