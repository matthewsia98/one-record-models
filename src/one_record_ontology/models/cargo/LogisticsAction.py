...
class LogisticsAction(LogisticsObject):
    ...
    actionTimeType: List[ActionTimeType] = Field(default_factory=list, serialization_alias="https://onerecord.iata.org/ns/cargo#actionTimeType")
    ...
    performedAt: List[Location] = Field(default_factory=list, serialization_alias="https://onerecord.iata.org/ns/cargo#performedAt")
    ...
    servedActivity: List[LogisticsActivity] = Field(default_factory=list, serialization_alias="https://onerecord.iata.org/ns/cargo#servedActivity")
    # label: actionEndTime
    ...
    actionEndTime: List[datetime] = Field(default_factory=list, serialization_alias="https://onerecord.iata.org/ns/cargo#actionEndTime")
    ...
    actionStartTime: List[datetime] = Field(default_factory=list, serialization_alias="https://onerecord.iata.org/ns/cargo#actionStartTime")